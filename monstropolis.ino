...
//const char *LIZARD_NAMES[] PROGMEM = {"Iv","Jhox","Edres","Urthi","Odhu","Dulrurth","Irthi","Nurhticun","Netirre","Rudegroch","Shosj","Vaess","Thacherk","Korhti","Nirhty","Boshu","Repestri","Asharu","Tork","Shisk","Doskos","Maslo","Ogge","Otes","Daltekhi","Thothrica","Lo","Esh","Nalthis","Etrin","Thurdyss","Thargox","Thoggy","Egisort","Shetistink","Lortignonk"};
